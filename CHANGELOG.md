...
## [0.4.0] - 2026-04-03
- **SOAP 1.2 AI Mock Generation**: AI-powered mock generation now supports SOAP APIs, in addition to existing OpenAPI/Swagger and GrapgQL support
- **Postmen collection and Usage**: Added new examples to Postman collection and usage documentation.

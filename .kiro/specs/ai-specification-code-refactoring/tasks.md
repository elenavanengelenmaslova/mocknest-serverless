...
- [ ] 3. Refactor prompt building to application layer

  - [ ] 3.1 Create prompt template resource files
  ...
  - [ ] 3.2 Create application layer prompt builder service
  ...
  - [ ] 3.3 Update BedrockServiceAdapter to use PromptBuilderService
  ...
  - [ ] 3.4 Update MockGenerationFunctionalAgent to build prompts
  ...
  - [ ] 3.5 Update Spring configuration for PromptBuilderService
...
- [ ] BedrockServiceAdapter contains only AWS SDK integration code (no prompt building methods)
- [ ] PromptBuilderService exists in application layer with prompt building logic
- [ ] All prompt text externalized to resource files (system-prompt.txt, spec-with-description.txt, correction.txt)
- [ ] Prompt content is byte-for-byte identical to original implementation
- [ ] All existing tests pass without modification
- [ ] Test coverage remains at 90%+
- [ ] Response parsing and mock creation logic remain unchanged

...
| **LambdaMemorySize** | Lambda function memory size in MB | `512` | Range: 512-10240 MB. Default optimized via Lambda Power Tuner. See [docs/PERFORMANCE.md](docs/PERFORMANCE.md). |

...
- **Memory**: Runtime defaults to [1024 MB](https://docs.aws.amazon.com/lambda/latest/dg/configuration-memory.html) (configurable 512–10240 MB); Generation defaults to 512 MB (configurable 256–10240 MB); RuntimeAsync defaults to 256 MB (configurable 128–10240 MB)
